...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white"
        ...
        <div class="w-full mx-auto flex flex-col justify-center items-center p-6 lg:p-8">
            <div class="flex justify-center">
                <img :src="logo" alt="" class="w-[150px] h-[150px]">
            ...
            <div class="mt-16">
                <div class="flex gap-2 justify-center items-center">
                    <label for="class">學年度</label>
                    <select id="lesson" name="class">
                        <option value="">選擇學年度</option>
                        <option value="up">113學年度上學期</option>
                        <option value="down">113學年度下學期</option>
                    </select>
                ...
                <table class="p-5 w-full">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="border border-gray-800 px-4 py-2">名稱</th>
                            <th class="border border-gray-800 px-4 py-2">授課老師</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
